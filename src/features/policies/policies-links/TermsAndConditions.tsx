      ...
      <div className="mx-4 my-10 sm:mx-80">
        ...
        <div>
          <p className="py-4 font-light">
            Welcome to UkExpress These terms and conditions outline the rules
            and regulations for the use of UkExpress’s Website.
          </p>
        ...
        <div>
          <p className="py-4 font-light">
            ...
            conditions in full. Do not continue to use UkExpress’s website if
          ...
          <p className="py-4 font-light">
            ...
            prevailing law of United Kingdom and European Union.
          </p>
          <p className="py-4 font-light">
        ...
        <div>
          ...
          <p className="py-4 font-light">
            We employ the use of cookies. By using UkExpress’s website you
            consent to the use of cookies in accordance with UkExpress’s privacy
        ...
        <div>
          ...
          <ul className="list-disc py-2 pl-7 font-light">
            ...
            <li>
              Redistribute content from UkExpress (unless content is
        ...
        <div>
          ...
          <ul className="list-disc py-2 pl-7 font-light">
            ...
            <li>
              ...
              that arise in contract, tort (including negligence) and for breach
              of statutory duty.
            </li>
          </ul>
