    ...
    <aside className="hidden min-h-screen w-1/4 sm:block">
      ...
      <nav className="mt-16 border-r border-gray-300 dark:border-gray-500">
        <ul className="grid-col-1 grid">
          <SidebarLink to={`${fullName}/account`} title="ACCOUNT INFORMATION" />
          <SidebarLink to={`${fullName}/cart`} title="MY CART" />
          <SidebarLink to={`${fullName}/password`} title="CHANGE PASSWORD" />
          <SidebarLink
            to="/"
            title="SIGN OUT"
