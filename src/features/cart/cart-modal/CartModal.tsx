...
export default function CartModal() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 top-0 z-10 bg-black/70 dark:bg-white/30">
      <div
        className="absolute bottom-0 left-3/4 right-0 top-0 z-10 border border-slate-300 bg-white p-4 text-black shadow-md  dark:border-gray-500 dark:bg-slate-900 dark:text-gray-400 dark:shadow-slate-700"
        ...
        <div className="flex h-full flex-col justify-between">
          <div className="flex flex-col items-start gap-2">
            <div className="flex w-full items-start justify-between dark:border-gray-500">
              <p className="pb-2 text-lg font-medium dark:text-white">
                My Cart
              </p>
